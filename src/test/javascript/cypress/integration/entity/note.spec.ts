...
describe('Note e2e test', () => {
  ...
  describe('new Note page', () => {
    ...
    it('should create an instance of Note', () => {
      cy.get(`[data-cy="content"]`).type('synergize invoice Towels').should('have.value', 'synergize invoice Towels');

      cy.get(`[data-cy="materialId"]`).type('Liaison Market').should('have.value', 'Liaison Market');

      cy.get(`[data-cy="created"]`).type('2022-05-17T10:15').blur().should('have.value', '2022-05-17T10:15');
