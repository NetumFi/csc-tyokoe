...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHHISTORY_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEARCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEARCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEARCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHHISTORY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEARCHHISTORY actions', async () => {
      const expectedActions = [
        {
