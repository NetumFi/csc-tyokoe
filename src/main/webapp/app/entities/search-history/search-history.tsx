...
export const SearchHistory = (props: RouteComponentProps<{ url: string }>) => {
    ...
    <div>
      <h2 id="search-history-heading" data-cy="SearchHistoryHeading">
        ...
        <div className="d-flex justify-content-end">
          ...
          <Link to="/search-history/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="csc2022App.searchHistory.home.createLabel">Create new Search History</Translate>
          </Link>
        </div>
      </h2>
          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="csc2022App.searchHistory.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {searchHistoryList.map((searchHistory, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{searchHistory.user ? searchHistory.user.login : ''}</td>
