...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_READINGLIST_LIST actions', async () => {
    ...
    it('dispatches FETCH_READINGLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_READINGLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_READINGLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_READINGLIST actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_READINGLIST actions', async () => {
      const expectedActions = [
        {
