...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './age.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGE actions', async () => {
      const expectedActions = [
        {
