...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './user-result-keyword.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERRESULTKEYWORD_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERRESULTKEYWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERRESULTKEYWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERRESULTKEYWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERRESULTKEYWORD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERRESULTKEYWORD actions', async () => {
      const expectedActions = [
        {
