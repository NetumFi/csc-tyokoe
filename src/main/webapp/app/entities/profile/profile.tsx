...
export const Profile = (props: RouteComponentProps<{ url: string }>) => {
  ...
  return (
    <div>
      <h2 id="profile-heading" data-cy="ProfileHeading">
        <Translate contentKey="csc2022App.profile.home.title">Profiles</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="csc2022App.profile.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/profile/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="csc2022App.profile.home.createLabel">Create new Profile</Translate>
          </Link>
        </div>
      </h2>
        ...
        {profileList && profileList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="csc2022App.profile.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('keywords')}>
                  <Translate contentKey="csc2022App.profile.keywords">Keywords</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('education')}>
                  <Translate contentKey="csc2022App.profile.education">Education</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('language')}>
                  <Translate contentKey="csc2022App.profile.language">Language</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="csc2022App.profile.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="csc2022App.profile.home.notFound">No Profiles found</Translate>
            </div>
          )
        )}
      </div>
