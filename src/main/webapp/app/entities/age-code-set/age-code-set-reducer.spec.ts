...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AGECODESET_LIST actions', async () => {
    ...
    it('dispatches FETCH_AGECODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_AGECODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_AGECODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_AGECODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_AGECODESET actions', async () => {
      const expectedActions = [
        {
