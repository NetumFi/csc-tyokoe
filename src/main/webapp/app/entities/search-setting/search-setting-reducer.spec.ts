...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SEARCHSETTING_LIST actions', async () => {
    ...
    it('dispatches FETCH_SEARCHSETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SEARCHSETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SEARCHSETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SEARCHSETTING actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SEARCHSETTING actions', async () => {
      const expectedActions = [
        {
