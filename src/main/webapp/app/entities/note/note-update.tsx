...
export const NoteUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...noteEntity,
          created: convertDateTimeFromServer(noteEntity.created),
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="csc2022App.note.home.createOrEditLabel" data-cy="NoteCreateUpdateHeading">
            <Translate contentKey="csc2022App.note.home.createOrEditLabel">Create or edit a Note</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('csc2022App.note.content')} id="note-content" name="content" data-cy="content" type="text" />
              <ValidatedField
                label={translate('csc2022App.note.materialId')}
                id="note-materialId"
                name="materialId"
                data-cy="materialId"
                type="text"
              />
              <ValidatedField
                label={translate('csc2022App.note.created')}
                id="note-created"
                name="created"
                data-cy="created"
                type="datetime-local"
              ...
              />
              <ValidatedField id="note-user" name="user" data-cy="user" label={translate('csc2022App.note.user')} type="select">
                <option value="" key="0" />
                {users
