...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './education-level-code-set.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_EDUCATIONLEVELCODESET_LIST actions', async () => {
    ...
    it('dispatches FETCH_EDUCATIONLEVELCODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_EDUCATIONLEVELCODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_EDUCATIONLEVELCODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_EDUCATIONLEVELCODESET actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_EDUCATIONLEVELCODESET actions', async () => {
      const expectedActions = [
        {
